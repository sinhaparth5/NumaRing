...
the CPU-to-node lookup cut that call itself by 61$\times$ (\SI{183}{\nano\second} to
\SI{2.97}{\nano\second}), and separately raised low-contention (2-thread) throughput by
6 to 7$\times$ end to end, two different measurements of the same fix, not the same number twice. A
second round of fixes to the cross-node work-stealing path removed an

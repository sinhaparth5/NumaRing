...
\begin{tikzpicture}[
  ...
  \draw[->, thick] ([yshift=2mm]r0.east) to[out=15,in=-15,looseness=1.6] node[lbl, right=1mm] {batched\\work steal\\(1 CAS/batch)} ([yshift=2mm]r1.east);
  \draw[->, thick] ([yshift=-2mm]r1.east) to[out=-165,in=165,looseness=1.6] ([yshift=-2mm]r0.east);
...
\begin{axis}[
  ...
  ymin=0, ymax=12.5,
  nodes near coords, nodes near coords style={font=\scriptsize, yshift=2mm},
